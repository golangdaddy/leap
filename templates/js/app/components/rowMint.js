...
export function RowMint(props) {
    ...
    function triggerMint() {	
		...
		setLocaldata(VisitTab(localdata, "mintconfirmation", context))
    }
    ...
    return (
		<div className="flex flex-row">
			<div className="flex flex-row justify-center items-center m-4 cursor-pointer" style={iconStyle} onClick={triggerMint}>
