...
import { LayerDELETE, LayersListGET, LayerMoveUpPOST, LayerMoveDownPOST } from '../_fetch';

import VisitTab from '@/features/interfaces';

import Loading from '@/app/loading';
import { Preview } from './layer';
...
export function LayerList(props) {
	...
	function updateList() {
		LayersListGET(userdata, props.subject?.Meta.ID, props.limit)
		.then((res) => res.json())
		.then((data) => {
			console.log(data)
			setList(data)
	...
	function selectItem(id) {
		...
		setLocaldata(VisitTab(localdata, "layer", context))
	}

	function moveUp(id) {
		const object = list[parseInt(id)]
		console.log("MOVE UP", object)
		LayerMoveUpPOST(userdata, object.Meta.ID)
	...
	function moveDown(id) {
		...
		LayerMoveDownPOST(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
	...
	function deleteItem(id) {
		...
		LayerDELETE(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
