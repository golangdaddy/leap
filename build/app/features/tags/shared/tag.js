	...
	return (
		<div className='flex flex-row justify-between items-center w-full my-2 px-4'>
			...
			<div onClick={selectItem} className='flex flex-row w-full items-center cursor-pointer'>
				...
				<Spacer/><div className='text-xl font-bold' title="foreground_color">{ props.item.fields["foreground_color"] }</div>
				<div className="px-4"></div>
				<Spacer/><div className='text-xl font-bold' title="background_color">{ props.item.fields["background_color"] }</div>
				<div className="px-4"></div>
				<Spacer/>
			</div>
			<RowEdit object={props.item} editInterface="edittag"/>
