...
import { AttributeDELETE, AttributesListGET, AttributeMoveUpPOST, AttributeMoveDownPOST } from '../_fetch';
...
export function AttributeList(props) {
	...
	function moveUp(id) {
		...
		AttributeMoveUpPOST(userdata, object.Meta.ID)
	...
	function moveDown(id) {
		...
		AttributeMoveDownPOST(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
