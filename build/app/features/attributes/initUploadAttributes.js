...
import { AttributeArchiveUpload } from './_fetch'

export function InitUploadAttributes(props) {
	...
	function handleSubmitFile(event) {
		...
		AttributeArchiveUpload(userdata, element.Meta.ID, formData).then((response) => {
