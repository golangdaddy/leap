...
import { CollectionArchiveUpload } from './_fetch'

export function InitUploadCollections(props) {
	...
	function handleSubmitFile(event) {
		...
		CollectionArchiveUpload(userdata, element.Meta.ID, formData).then((response) => {
