...
import { CollectionDELETE, CollectionsListGET, CollectionMoveUpPOST, CollectionMoveDownPOST } from '../_fetch';

import VisitTab from '@/features/interfaces';

import Loading from '@/app/loading';
import { Preview } from './collection';
...
export function CollectionList(props) {
	...
	function updateList() {
		CollectionsListGET(userdata, props.subject?.Meta.ID, props.limit)
		.then((res) => res.json())
		.then((data) => {
			console.log(data)
			setList(data)
	...
	function selectItem(id) {
		...
		setLocaldata(VisitTab(localdata, "collection", context))
	}

	function moveUp(id) {
		const object = list[parseInt(id)]
		console.log("MOVE UP", object)
		CollectionMoveUpPOST(userdata, object.Meta.ID)
	...
	function moveDown(id) {
		...
		CollectionMoveDownPOST(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
	...
	function deleteItem(id) {
		...
		CollectionDELETE(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
