...
import { ElementDELETE, ElementsListGET, ElementMoveUpPOST, ElementMoveDownPOST } from '../_fetch';
...
export function ElementList(props) {
	...
	function moveUp(id) {
		...
		ElementMoveUpPOST(userdata, object.Meta.ID)
	...
	function moveDown(id) {
		...
		ElementMoveDownPOST(userdata, object.Meta.ID)
		.then((res) => console.log(res))
		.then(function () {
			updateList()
		})
