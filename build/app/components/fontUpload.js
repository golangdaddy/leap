...
import { FontUploadPOST } from '@/app/fetch';
import { useLocalContext } from '@/context/local';

import Loading from '@/app/loading';
import { GoBack } from '@/features/interfaces';

export function FontUpload(props) {
	...
	function handleSubmitFile(event) {
		...
		FontUploadPOST(userdata, element.Meta.ID, formData).then((response) => {
	...
	return (
		<div className="flex flex-col">
				...
				{
					!loading && <>
						<div className='my-3 font-medium'>Font upload</div>
						<div className='flex flex-col'>
