...
func (self *GCPClients) ListObjectsGCS(ctx context.Context, bucketName string, prefix *string) (names []string, err error) {
	...
	it := self.GCS().Bucket(bucketName).Objects(ctx, q)
	for {
